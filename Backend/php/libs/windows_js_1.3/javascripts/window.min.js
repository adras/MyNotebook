var Window=Class.create();Window.keepMultiModalWindow=!1;Window.hasEffectLib=typeof Effect!="undefined";Window.resizeEffectDuration=0.4;
...
"px"}),this.useLeft=!1);typeof this.options.top!="undefined"?(this.element.setStyle({top:parseFloat(this.options.top)+"px"}),this.useTop=!0):(this.element.setStyle({bottom:parseFloat(this.options.bottom)+"px"}),this.useTop=!1);this.storedLocation=null;this.setOpacity(this.options.opacity);this.options.zIndex&&this.setZIndex(this.options.zIndex);this.options.destroyOnClose&&this.setDestroyOnClose(!0);this._getWindowBorderSize();this.width=this.options.width;this.height=this.options.height;this.constraint=
...
this._setAjaxContent.bind(this);b.onComplete=this._onCompleteHandler;new Ajax.Request(a,b);b.onComplete=this.onComplete},_setAjaxContent:function(a){Element.update(this.getContent(),a.responseText);if(this.onComplete)this.onComplete(a);this.onComplete=null;this[this.showFunction](this.showModal)},setURL:function(a){if(this.options.url)this.content.src=null;this.options.url=a;a="<iframe frameborder='0' name='"+this.getId()+"_content'  id='"+this.getId()+"_content' src='"+a+"' width='"+this.width+"' height='"+
this.height+"'> </iframe>";$(this.getId()+"_table_content").innerHTML=a;this.content=$(this.element.id+"_content")},getURL:function(){return this.options.url?this.options.url:null},refresh:function(){if(this.options.url)$(this.element.getAttribute("id")+"_content").src=this.options.url},setCookie:function(a,b,c,d,e){a=a||this.element.id;this.cookie=[a,b,c,d,e];if(a=WindowUtilities.getCookie(a)){var f=a.split(","),a=f[0].split(":"),b=f[1].split(":"),c=parseFloat(f[2]),d=parseFloat(f[3]),e=f[4],f=f[5];
this.setSize(c,d);if(e=="true")this.doMinimize=!0;else if(f=="true")this.doMaximize=!0;this.useLeft=a[0]=="l";this.useTop=b[0]=="t";this.element.setStyle(this.useLeft?{left:a[1]}:{right:a[1]});this.element.setStyle(this.useTop?{top:b[1]}:{bottom:b[1]})}},getId:function(){return this.element.id},setDestroyOnClose:function(){this.options.destroyOnClose=!0},setConstraint:function(a,b){this.constraint=a;this.constraintPad=Object.extend(this.constraintPad,b||{});this.useTop&&this.useLeft&&this.setLocation(parseFloat(this.element.style.top),
parseFloat(this.element.style.left))},_initDrag:function(a){if(!(Event.element(a)==this.sizer&&this.isMinimized())&&!(Event.element(a)!=this.sizer&&this.isMaximized())){Prototype.Browser.IE&&this.heightN==0&&this._getWindowBorderSize();this.pointer=[this._round(Event.pointerX(a),this.options.gridX),this._round(Event.pointerY(a),this.options.gridY)];this.currentDrag=this.options.wiredDrag?this._createWiredElement():this.element;if(Event.element(a)==this.sizer)this.doResize=!0,this.widthOrg=this.width,
this.heightOrg=this.height,this.bottomOrg=parseFloat(this.element.getStyle("bottom")),this.rightOrg=parseFloat(this.element.getStyle("right")),this._notify("onStartResize");else{this.doResize=!1;var b=$(this.getId()+"_close");if(b&&Position.within(b,this.pointer[0],this.pointer[1])){this.currentDrag=null;return}this.toFront();if(!this.options.draggable)return;this._notify("onStartMove")}Event.observe(document,"mouseup",this.eventMouseUp,!1);Event.observe(document,"mousemove",this.eventMouseMove,!1);
WindowUtilities.disableScreen("__invisible__","__invisible__",this.overlayOpacity);document.body.ondrag=function(){return!1};document.body.onselectstart=function(){return!1};this.currentDrag.show();Event.stop(a)}},_round:function(a,b){return b==1?a:Math.floor(a/b)*b},_updateDrag:function(a){var b=[this._round(Event.pointerX(a),this.options.gridX),this._round(Event.pointerY(a),this.options.gridY)],c=b[0]-this.pointer[0],d=b[1]-this.pointer[1];if(this.doResize){var b=this.widthOrg+c,e=this.heightOrg+
d,c=this.width-this.widthOrg,d=this.height-this.heightOrg;this.useLeft?b=this._updateWidthConstraint(b):this.currentDrag.setStyle({right:this.rightOrg-c+"px"});this.useTop?e=this._updateHeightConstraint(e):this.currentDrag.setStyle({bottom:this.bottomOrg-d+"px"});this.setSize(b,e);this._notify("onResize")}else this.pointer=b,this.useLeft?(c=parseFloat(this.currentDrag.getStyle("left"))+c,b=this._updateLeftConstraint(c),this.pointer[0]+=b-c,this.currentDrag.setStyle({left:b+"px"})):this.currentDrag.setStyle({right:parseFloat(this.currentDrag.getStyle("right"))-
c+"px"}),this.useTop?(d=parseFloat(this.currentDrag.getStyle("top"))+d,c=this._updateTopConstraint(d),this.pointer[1]+=c-d,this.currentDrag.setStyle({top:c+"px"})):this.currentDrag.setStyle({bottom:parseFloat(this.currentDrag.getStyle("bottom"))-d+"px"}),this._notify("onMove");this.iefix&&this._fixIEOverlapping();this._removeStoreLocation();Event.stop(a)},_endDrag:function(a){WindowUtilities.enableScreen("__invisible__");this.doResize?this._notify("onEndResize"):this._notify("onEndMove");Event.stopObserving(document,
"mouseup",this.eventMouseUp,!1);Event.stopObserving(document,"mousemove",this.eventMouseMove,!1);Event.stop(a);this._hideWiredElement();this._saveCookie();document.body.ondrag=null;document.body.onselectstart=null},_updateLeftConstraint:function(a){if(this.constraint&&this.useLeft&&this.useTop){var b=this.options.parent==document.body?WindowUtilities.getPageSize().windowWidth:this.options.parent.getDimensions().width;if(a<this.constraintPad.left)a=this.constraintPad.left;a+this.width+this.widthE+
this.widthW>b-this.constraintPad.right&&(a=b-this.constraintPad.right-this.width-this.widthE-this.widthW)}return a},_updateTopConstraint:function(a){if(this.constraint&&this.useLeft&&this.useTop){var b=this.options.parent==document.body?WindowUtilities.getPageSize().windowHeight:this.options.parent.getDimensions().height,c=this.height+this.heightN+this.heightS;if(a<this.constraintPad.top)a=this.constraintPad.top;a+c>b-this.constraintPad.bottom&&(a=b-this.constraintPad.bottom-c)}return a},_updateWidthConstraint:function(a){if(this.constraint&&
...
c=parseFloat(this.element.getStyle("top"));c+a+this.heightN+this.heightS>b-this.constraintPad.bottom&&(a=b-this.constraintPad.bottom-c-this.heightN-this.heightS)}return a},_createWindow:function(a){var b=this.options.className,c=document.createElement("div");c.setAttribute("id",a);c.className="dialog";c.innerHTML=(this.options.closable?"<div class='"+b+"_close' id='"+a+"_close' onclick='Windows.close(\""+a+"\", event)'> </div>":"")+(this.options.minimizable?"<div class='"+b+"_minimize' id='"+a+"_minimize' onclick='Windows.minimize(\""+
a+"\", event)'> </div>":"")+(this.options.maximizable?"<div class='"+b+"_maximize' id='"+a+"_maximize' onclick='Windows.maximize(\""+a+"\", event)'> </div>":"")+"      <table id='"+a+"_row1' class=\"top table_window\">        <tr>          <td class='"+b+"_nw'></td>          <td class='"+b+"_n'><div id='"+a+"_top' class='"+b+"_title title_window'>"+this.options.title+"</div></td>          <td class='"+b+"_ne'></td>        </tr>      </table>      <table id='"+a+"_row2' class=\"mid table_window\">        <tr>          <td class='"+
b+"_w'></td>            <td id='"+a+"_table_content' class='"+b+"_content' valign='top'>"+(this.options.url?'<iframe frameborder="0" name="'+a+'_content"  id="'+a+'_content" src="'+this.options.url+'"> </iframe>':'<div id="'+a+'_content" class="'+b+'_content"> </div>')+"</td>          <td class='"+b+"_e'></td>        </tr>      </table>        <table id='"+a+"_row3' class=\"bot table_window\">        <tr>          <td class='"+b+"_sw'></td>            <td class='"+b+"_s'><div id='"+a+"_bottom' class='status_bar'><span style='float:left; width:1px; height:1px'></span></div></td>            <td "+
(this.options.resizable?"class='"+b+"_sizer' id='"+a+"_sizer'":"class='"+b+"_se'")+"></td>        </tr>      </table>    ";Element.hide(c);this.options.parent.insertBefore(c,this.options.parent.firstChild);Event.observe($(a+"_content"),"load",this.options.onload);return c},changeClassName:function(a){var b=this.options.className,c=this.getId();$A(["_close","_minimize","_maximize","_sizer","_content"]).each(function(d){this._toggleClassName($(c+d),b+d,a+d)}.bind(this));this._toggleClassName($(c+"_top"),
b+"_title",a+"_title");$$("#"+c+" td").each(function(c){c.className=c.className.sub(b,a)});this.options.className=a},_toggleClassName:function(a,b,c){a&&(a.removeClassName(b),a.addClassName(c))},setLocation:function(a,b){var a=this._updateTopConstraint(a),b=this._updateLeftConstraint(b),c=this.currentDrag||this.element;c.setStyle({top:a+"px"});c.setStyle({left:b+"px"});this.useTop=this.useLeft=!0},getLocation:function(){var a={},a=this.useTop?Object.extend(a,{top:this.element.getStyle("top")}):Object.extend(a,
...
null)this._restoreLocation(),this.iefix&&this.iefix.hide();else{this._storeLocation();Windows.unsetOverflow(this);var a=WindowUtilities.getWindowScroll(this.options.parent),b=WindowUtilities.getPageSize(this.options.parent),c=a.left,a=a.top;if(this.options.parent!=document.body)c=this.options.parent.getDimensions(),b.windowWidth=c.width,b.windowHeight=c.height,c=a=0;this.constraint&&(b.windowWidth-=Math.max(0,this.constraintPad.left)+Math.max(0,this.constraintPad.right),b.windowHeight-=Math.max(0,
this.constraintPad.top)+Math.max(0,this.constraintPad.bottom),c+=Math.max(0,this.constraintPad.left),a+=Math.max(0,this.constraintPad.top));var d=b.windowWidth-this.widthW-this.widthE,b=b.windowHeight-this.heightN-this.heightS;this.useLeft&&this.useTop&&Window.hasEffectLib&&Effect.ResizeWindow?new Effect.ResizeWindow(this,a,c,d,b,{duration:Window.resizeEffectDuration}):(this.setSize(d,b),this.element.setStyle(this.useLeft?{left:c}:{right:c}),this.element.setStyle(this.useTop?{top:a}:{bottom:a}));
...
_saveCookie:function(){if(this.cookie){var a="";a+=this.useLeft?"l:"+(this.storedLocation?this.storedLocation.left:this.element.getStyle("left")):"r:"+(this.storedLocation?this.storedLocation.right:this.element.getStyle("right"));a+=this.useTop?",t:"+(this.storedLocation?this.storedLocation.top:this.element.getStyle("top")):",b:"+(this.storedLocation?this.storedLocation.bottom:this.element.getStyle("bottom"));a+=","+(this.storedLocation?this.storedLocation.width:this.width);a+=","+(this.storedLocation?
this.storedLocation.height:this.height);a+=","+this.isMinimized();a+=","+this.isMaximized();WindowUtilities.setCookie(a,this.cookie)}},_createWiredElement:function(){if(!this.wiredElement){Prototype.Browser.IE&&this._getWindowBorderSize();var a=document.createElement("div");a.className="wired_frame "+this.options.className+"_wired_frame";a.style.position="absolute";this.options.parent.insertBefore(a,this.options.parent.firstChild);this.wiredElement=$(a)}this.useLeft?this.wiredElement.setStyle({left:this.element.getStyle("left")}):
this.wiredElement.setStyle({right:this.element.getStyle("right")});this.useTop?this.wiredElement.setStyle({top:this.element.getStyle("top")}):this.wiredElement.setStyle({bottom:this.element.getStyle("bottom")});a=this.element.getDimensions();this.wiredElement.setStyle({width:a.width+"px",height:a.height+"px"});this.wiredElement.setStyle({zIndex:Windows.maxZIndex+30});return this.wiredElement},_hideWiredElement:function(){if(this.wiredElement&&this.currentDrag)this.currentDrag==this.element?this.currentDrag=
null:(this.useLeft?this.element.setStyle({left:this.currentDrag.getStyle("left")}):this.element.setStyle({right:this.currentDrag.getStyle("right")}),this.useTop?this.element.setStyle({top:this.currentDrag.getStyle("top")}):this.element.setStyle({bottom:this.currentDrag.getStyle("bottom")}),this.currentDrag.hide(),this.currentDrag=null,this.doResize&&this.setSize(this.width,this.height))},_notify:function(a){if(this.options[a])this.options[a](this);else Windows.notify(a,this)}};
